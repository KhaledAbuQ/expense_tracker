      ...
      <div className="space-y-4">
        ...
        {success ? (
          <div className="p-6 rounded-2xl bg-emerald-50 border border-emerald-200 text-center space-y-2">
            ...
            <h4 className="font-semibold text-emerald-900 text-sm">QR Code Recognized!</h4>
            <p className="text-xs text-emerald-700 font-mono break-all">{success.url}</p>
            <p className="text-xs text-emerald-600">Connecting database…</p>
          </div>
        ) : (
        ...
        <div className="pt-2 border-t border-slate-100 flex flex-col gap-2">
          ...
          <button
            ...
            className="w-full inline-flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl border border-slate-200 hover:bg-slate-50 text-slate-700 text-xs font-semibold transition"
          >
